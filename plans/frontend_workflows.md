...
**Status**: Envisioning stage. These are the highest value workflows but need work to integrate them in the UI for a seamless embryologist UX. 

**high impact workflows**

1. **Patient overview** — enter patient ID, see all embryos as cards with
...
Think in terms of a busy embryologist in the clinic who has intuition but wants to be guided by predictive modeling and visualize results to make their own opinions. 
